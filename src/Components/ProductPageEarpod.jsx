  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const responseData = await fetch('http://localhost:4000/earpod/data');
        const responseImage = await fetch('http://localhost:4000/earpod/images');
...
export default ProductPageEarpod;
