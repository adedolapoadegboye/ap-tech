  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const responseData = await fetch('http://localhost:4000/accessory/data');
        const responseImage = await fetch('http://localhost:4000/accessory/images');
...
export default ProductPageAccessory;
